  ...
  return (
    <Fragment>
      <section className="flex flex-col items-center py-12 min-h-screen">
        <h1 className="font-bold md:text-4xl text-3xl flex items-center gap-2 pb-4 tracking-tight  text-green-500 ">
          Spotlefy <FaSpotify />
        </h1>
        ...
        <p className="text-gray-400 text-center sm:text-base text-sm mt-4">
